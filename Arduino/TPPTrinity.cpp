...
unsigned long ms[3]; // stores timing values for each channel
int rows[3]; // stores what row we use for rainbow flash modes
int states[3]; // stores boolean values for on off states for each channel
int fades[3];
int two;
int three;
...
void Load(int address)
	{
	EEPROM_readAnything(address, config);
...
void Modes()
	...
	for (i = 0; i < 5; i++) // starting with channel 0, apply settings to strips, then move to the next channel.
		...
		sens = data[i][6];
		unicorns = data[i][7];
		if(rows[i] > 8) // played with this to eliminate Black rotation, may need to undo!
			{
			rows[i] = 0;
			}
		row = rows[i];
		...
		switch(mode)
			...
			if (pulse > sens)
				...
				break;
				case 36: // Flash 2 Colors
				
				break;
				case 37: // Flash 3 Colors
				
				break;
				case 38: // Flash 4 Colors
				
				break;
				case 39: // Flash 5 Colors
				...
				break;
				case 44: // Audio Flash 2 Colors
				
				break;
				case 45: // Audio Flash 3 Colors
				
				break;
				case 46: // Audio Flash 4 Colors
				
				break;
				case 47: // Audio Flash 5 Colors
				
				break;
				case 48: // Sync Audio Flash 2 Colors
				
				break;
				case 49: // Sync Audio Flash 3 Colors
				
				break;
				case 50: // Sync Audio Flash 4 Colors
				
				break;
				case 51: // Sync Audio Flash 5 Colors
				
				break;
				case 52: // Sync 2 Color UFO Advance
				
				break;
				case 53: // Sync 3 Color UFO Advance
				
				break;
				case 54: // Sync 4 Color UFO Advance
				
				break;
				case 55: // Sync 5 Color UFO Advance
				
				break;
				case 56: // Sync 2 Color UFO Replace
				
				break;
				case 57: // Sync 3 Color UFO Replace
				
				break;
				case 58: // Sync 4 Color UFO Replace
				
				break;
				case 59: // Sync 5 Color UFO Replace
				}
			}
		}
